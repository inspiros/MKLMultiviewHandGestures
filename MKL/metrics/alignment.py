...
.. currentmodule:: MKL.metrics.alignment
...
import numpy as np
from MKL.utils.validation import check_squared, check_K_Y
from MKL.utils.matrices import ideal_kernel,identity_kernel
