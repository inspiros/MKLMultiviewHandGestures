...
import numpy as np
import sys
from MKL.algorithms.base import MKL
...
.. currentmodule:: MKL.utils.mkl_checks

This module is used to check if a MKL algorithm is compliant with MKL,
...
def check_estimator(mkl):
	"""check if a MKL algorithm is compliant with MKL
