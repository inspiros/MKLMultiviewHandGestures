...
class OneVsRestMKLClassifier():
    def __init__(self, clf1, verbose=True):
        self.clf1 = clf1
        self.clf2 = clf1.estimator
        self.verbose = verbose
    ...
    def fit(self, K_list, Y, max_iter=None):
        n = len(Y)
        ...
        for model in classes_:
            if self.verbose:
                print('[OneVsRestMKLClassifier] Learning MKL for class ' + str(model))
            ...
            if cc1.max_iter > max_iter:
                max_iter = cc1.max_iter
